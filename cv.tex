...
\section{Education}
\cventry{2026.08 -- Present}{Master of Science in \textbf{Computer Science}}{University of Illinois Urbana-Champaign}{Urbana-Champaign, IL, USA}{}{}
...
\cventry{2024.04 -- 2026.07}{\textbf{Security Researcher}}{Enki WhiteHat}{}{}{
  \begin{itemize}
    \item Conducted research on Windows kernel security and exploitation techniques
    \item Discovered privilege escalation vulnerabilities using \textbf{KAFL} for kernel fuzzing
    \item Researched Chromium browser security with \textbf{Fuzzilli} framework
    \item Developed exploitation techniques for modern web browsers
    \item Contributed to vulnerability disclosure programs (Microsoft, Apple)
  \end{itemize}
}
